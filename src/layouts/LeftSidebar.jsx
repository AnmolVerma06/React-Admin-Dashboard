...
import profileImg from "@/assets/images/users/user-12.jpg";
import logoSm from "@/assets/images/logo-2-sm.png";
import logoDark from "@/assets/images/logo-2.png";
import logoDark2 from "@/assets/images/logo-2.png";
import logoLight from "@/assets/images/logo-2-dark.png";
import logoLight2 from "@/assets/images/logo-2-dark.png";
  ...
  return <React.Fragment>
            <div className="app-menu" ref={menuNodeRef}>
              ...
              <span className="logo-sm">
                ...
                <img src={orientation === 'two-column' ? logoDark2 : logoDark} alt="" height="35" />
              </span>
                        </Link>
              ...
              <span className="logo-sm">
                <img src={logoSm} alt="" height="22" />
                            ...
                            <span className="logo-lg">
                <img src={orientation === 'two-column' ? logoLight2 : logoLight} alt="" height="35" />
              </span>
                        </Link>
                    </div>}
